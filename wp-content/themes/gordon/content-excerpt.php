...
?><article id="post-<?php the_ID(); ?>" 
	<?php post_class( 'post_item post_layout_excerpt post_format_'.esc_attr($gordon_post_format) ); ?>
	<?php echo (!gordon_is_off($gordon_animation) ? ' data-animation="'.esc_attr(gordon_get_animation_classes($gordon_animation)).'"' : ''); ?>
	><?php

	// Featured image
	gordon_show_post_featured(array( 'thumb_size' => gordon_get_thumb_size( strpos(gordon_get_theme_option('body_style'), 'full')!==false ? 'full' : 'big' ) ));
