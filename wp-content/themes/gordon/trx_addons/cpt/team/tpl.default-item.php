...
<div class="sc_team_item">
	...
	trx_addons_get_template_part('templates/tpl.featured.php',
								...
								apply_filters('trx_addons_filter_args_featured', array(
												...
												'hover' => 'zoomin',
												'thumb_size' => gordon_get_thumb_size( 'team' )
												), 'team-default')
								);
	?>
	<div class="sc_team_item_info">
		...
		?>
		<div class="sc_team_item_button"><a href="<?php echo esc_url($link); ?>" class="sc_button sc_button_simple"><?php esc_html_e('Learn more', 'gordon'); ?></a></div>
	</div>
</div>
<?php
