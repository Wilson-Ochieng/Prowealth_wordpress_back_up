...
if (!function_exists('gordon_trx_addons_get_css')) {
	add_filter('gordon_filter_get_css', 'gordon_trx_addons_get_css', 10, 4);
	function gordon_trx_addons_get_css($css, $colors, $fonts, $scheme='') {
...
.select_container::-webkit-input-placeholder,
...
.sc_layouts_menu_nav > li li > a {
	color: {$colors['sub_menu']} !important;
}
