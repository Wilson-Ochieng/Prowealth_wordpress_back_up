                        ...
                        <div class="get_content">
                            ...
                            if (!empty($buttons)) {
                                foreach ($buttons as $i => $button) {
                                    ...
                                    $icon = !empty($button['btn_type'] == 'image') ? '<img src="'.$button['image_icon']['url'].'" alt="download button">' : '<i class="fab ' . esc_attr($button['font_icon']) . '"></i>';
                                    if (!empty($button['btn_title'])) : ?>
                                        <a href="<?php echo esc_url($button_url['url']) ?>"
                                           ...
                                           data-wow-delay="0.<?php echo esc_attr($delay) ?>s"
                                            <?php echo $btn_target; ?>>
                                            <?php echo $icon; ?>
