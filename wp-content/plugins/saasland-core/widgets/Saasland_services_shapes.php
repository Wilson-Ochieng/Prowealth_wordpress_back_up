                         ...
                         <div class="col-lg-6 d-flex align-items-center">
                             <div class="s_features_content pl_120">
                                ...
                                <?php if(!empty($list_service['link_title'])) : ?>
                                     <a href="<?php echo esc_attr($service['link_url']['url']) ?>" class="learn_btn" <?php saasland_is_external($list_service['link_url']) ?>>
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            'title', [
                ...
                'label_block' => true,
                'default' => 'If you Rely on Independent Contractors, SaasLand<br> was Built Specifically for You'
            ]
        );
        ...
        $service_fields->start_controls_tab(
            'icon_colors_tab',
            [
                'label' => __( 'Icon Colors', 'plugin-name' ),
            ]
        );
        $service_fields->add_control(
            'icon_color',
			...
			'list_services', [
				...
				'fields' => [
					...
					/*[
                        ...
                        'default'   => 'ti_icon',
                        'options'   => [
                            'ti_icon'     => esc_html__('Themify Icon', 'saasland-core'),
                            'image_icon'    => esc_html__('Image/SVG Icon', 'saasland-core'),
                        ],
                    ],*/
                    [
                        'name'       => 'ti_icon',
