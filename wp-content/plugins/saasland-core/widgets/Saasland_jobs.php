        ...
        <div class="job_listing">
            ...
            <div class="listing_tab" id="tab_filter">
                ...
                while ($wp_query->have_posts()) : $wp_query->the_post();
                    ...
                    $apply_url = home_url("/$temp_slug?id=").get_the_ID();
                    ?>
                                ...
                                <div class="job_list_table">
                                    ...
                                    <div class="jobsearch-table-cell">
                                        <div class="jobsearch-job-userlist">
                                            <a href="<?php echo esc_url($apply_url) ?>" <?php saasland_is_external($settings['external_apply_url']) ?> class="apply_btn"> <?php echo esc_html($apply) ?> </a>
                                            <!--<div class="like-btn">
