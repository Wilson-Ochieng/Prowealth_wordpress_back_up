 ...
 * @since 1.7.0
 */
class Saasland_faq_with_tab extends Widget_Base {

    public function get_name() {
        return 'saasland_faq_with_tab';
    }

    public function get_title() {
        return __( 'FAQ with Tab', 'saasland-hero' );
    }
                    ...
                    <div class="col-lg-5 col-md-6">
                        <div class="fun_fact_content">
                            <?php if (!empty($settings['title'])) : ?>
                                <h1 class="w_color f_p f_700 mb_20">
                                ...
                                if(is_array($counters)) {
                                    foreach ($counters as $i => $counter) { ?>
                                        <div class="fact_item <?php echo ($i == 0) ? '' : 'pl_100'; ?>">
                                            <h1 class="w_color">
                                                <span> <?php echo esc_html($counter['count_value']) ?> </span><?php echo esc_html($counter['count_append']) ?>
                                            </h1>
