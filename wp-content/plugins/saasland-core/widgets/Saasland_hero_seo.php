            ...
            <?php if($settings['is_bg_objects'] == 'yes') : ?>
                <div class="home_bubble">
                    ...
                    <div class="triangle b_eight" data-parallax='{"x": 120, "y": -10}'>
                        <img src="<?php echo plugins_url('images', __FILE__) ?>/seo/triangle_two.png" alt="">
                    </div>
                    <div class="triangle b_nine"><img src="<?php echo plugins_url('images', __FILE__) ?>/seo/triangle_three.png" alt=""></div>
                </div>
            <?php endif; ?>
                    ...
                    <div class="row">
                        <div class="col-md-12 text-center seo_banner_content">
                            <?php if(!empty($settings['title'])) : ?>
                                <h2 class="title wow fadeInUp" data-wow-delay="0.3s"> <?php echo wp_kses_post(nl2br($settings['title'])); ?> </h2>
                            <?php endif; ?>
